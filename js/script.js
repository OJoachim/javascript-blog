...
/* 2 część skryptu - chcemy generować nową listę linków po każdym kliknięciu tagu lub autora */
	...
	function generateTitleLinks(){ //deklaracja
		...
		/* [-2b-] find the title element  /	propozycja kodilli w 1-linii:
											articleTitle = article.querySelector(optTitleSelector).innerHTML;/ */
		
		const articleTitle = article.querySelector(optTitleSelector);
			console.log('articleTitle', articleTitle);

		/* [-2c-] get the title from the title element */
		}
		
		const articleTitle = optTitleSelector.innerHTML;
		

		/* [-2d-]create HTML of the link */
		
		// const linkHTML = '<li><a href="#' + articleId + '"><span>' + articleTitle + '</span></a></li>';

		/* [-2e-] insert link into titleList */
